    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.grid}>
        {subjects.map((subject, index) => (
          <TouchableOpacity onPress={() => navigation.push('Section', { subject: subject.title })} key={index} style={[styles.card, { backgroundColor: subject.color }]}>
      ...
      <View style={styles.Listcontainer}>
        ...
        />
        {/* <View>
          <Video  source={require('../../assets/DashbordImage/hello.mp4')}
          style={{ width: 200, height: 120 }}
        muted={false}
        repeat={true}
        resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  card: {
    width: (width - 47) / 2, // Two cards with margin
    height: 100,
    borderRadius: 12,
    marginBottom: 16,
    padding: 12,
